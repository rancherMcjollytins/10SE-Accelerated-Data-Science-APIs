...
-   Save/Load
    - Filtered Data and other important pieces of information can be saved to/loaded from different filetypes to allow for quick analysis and access between sessions.
